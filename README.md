...
![Version](https://img.shields.io/badge/Version-4.2.3-red.svg)
...
dependencies {
    implementation "dev.lightdream:message-builder:4.2.3"
    implementation "com.github.L1ghtDream:message-builder:4.2.3"
}
```
